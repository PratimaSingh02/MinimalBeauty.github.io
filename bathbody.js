window.onload = () =>{
    ...
    let productJson = '{"product":[' +
            '{"imgSrc":"./img/bath1.jpg","name":"Product 1","price":699.00,"sold_out":1},' +
            '{"imgSrc":"./img/bath1.jpg","name":"Product 2","price":1199.00,"sold_out":0},' +
            '{"imgSrc":"./img/bath1.jpg","name":"Product 3","price":750.00,"sold_out":1 },' +
            '{"imgSrc":"./img/bath1.jpg","name":"Product 4","price":699.00,"sold_out":1 },' +
            '{"imgSrc":"./img/bath1.jpg","name":"Product 5","price":1999.00,"sold_out":0 },' +
            '{"imgSrc":"./img/bath1.jpg","name":"Product 6","price":799.00,"sold_out":1 },' +
            '{"imgSrc":"./img/bath1.jpg","name":"Product 7","price":1599.00,"sold_out":0 } ]}';
